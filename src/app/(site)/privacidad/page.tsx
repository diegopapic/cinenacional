    ...
    <div className="mx-auto w-full max-w-3xl px-4 py-12 md:px-8 md:py-16">
      ...
      <div className="prose prose-invert prose-sm mt-8 max-w-none text-foreground/80 [&_h2]:font-serif [&_h2]:text-lg [&_h2]:text-foreground/90 [&_h2]:mt-8 [&_h2]:mb-3 [&_p]:leading-relaxed [&_p]:mb-4 [&_ul]:mb-4 [&_li]:mb-1">
        ...
        <p>
          ...
          su <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline">política de privacidad</a> y
          desactivar el seguimiento instalando
          el <a href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline">complemento de inhabilitación de Google Analytics</a>.
        </p>
        ...
        <p>
          ...
          a <a href="mailto:info@cinenacional.com" className="text-accent hover:underline">info@cinenacional.com</a>.
        </p>
      </div>
    </div>
  )
